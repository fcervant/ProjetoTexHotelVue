        ...
        <section class="sec">
            <div class="acomodacoes">
                ...
                <tr>
                    ...
                    <p1><br />Aqui você poderá descansar e usufruir de todo o
                        ...
                        livre (NetFlix, Prime e canais abertos).</p1>
                    <br /><br />
                    <p1>
                        A acomodação possui ainda uma sala um sofá grande e uma
                ...
                <tr>
                    ...
                    <tdRight>
                    <h3>
                        Nada melhor do que curtir uns dias com a família em nosso
                        hotel!
                    </h3>
                    <p1><br />
                        ...
                        abertos). <br /><br />
                        A sala ainda possui um sofá cama caso seja necessário hospedar
                ...
                <tr>
                    <tdLeft>
                    <h2>Economic Single - "Recanto da Águia"</h2>
                    <br />
                    <div class="acomodacoes">
                    ...
                    <br />
                    <p1>
                        Nosso quarto básico possui uma cama confortável, TV a cabo e
                        frigobar. Tem ainda uma mesa de trabalho caso tenha que
                        realizar alguma atividade pela empresa, ou mesmo se reunir com
                        mais alguém.<br /><br />
                        A melhor opção da região - simplicidade sem perder o conforto,
                        e isso por um preço justo!
                    </p1>
                    <br /><br />
                    <h4>R$ $$</h4>
                    <br /><br />
...
/* FRC - inclusão CSS para form_reserva */
/* CSS para modal */
.modal {
  font-size: 1.5em;
  color: #020202;
...
.gridReserva > div.resumo {
  grid-column: 2;
  border: 10px solid rgb(221, 97, 97);
  border-radius: 15px;
  grid-row: 1/3;
...
.gridReserva > div.resumo form {
  border: 2px solid rgb(221, 97, 97);
  border-radius: 5px;
  display: block;
}

.gridReserva > div.resumo h1 {
  font-size: 2em;
  color: rgb(225, 11, 11);
  font-weight: 300;
}

.gridReserva > div.resumo h3 {
  font-size: 2em;
  color: rgb(18, 17, 17);
  font-weight: 300;
}

.gridReserva > div.resumo p {
  font-size: 2em;
  color: rgb(18, 17, 17);
  font-weight: 300;
}
